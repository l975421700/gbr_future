...
for idate in daterange:
    ...
    clp_fl = sorted(glob.glob(f'scratch/data/obs/jaxa/clp/{year}{month:02d}/{day}/*/CLP_{year}{month:02d}{day}????.nc'))
    ...
    ofile = f'scratch/data/obs/jaxa/clp/{year}{month:02d}/{day}/CL_Frequency_{year}{month:02d}{day}.nc'
