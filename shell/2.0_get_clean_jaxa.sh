    ...
    for day in $(seq 22 31); do
        ...
        #     hour=$(printf '%02d' $hour)
            for minute in 00 10 20 30 40 50; do
                ...
                wget -q -r -nH --cut-dirs=5 --continue --no-remove-listing --ftp-user='gaoqg229_gmail.com' --ftp-password='SP+wari8' --glob=on -A "NC_H*_$year$month${day}_$hour${minute}_L2CLP010_FLDK.02401_02401.nc" ftp://ftp.ptree.jaxa.jp/pub/himawari/L2/CLP/010/$year$month/$day/$hour/ -P /home/563/qg8515/data/obs/jaxa/clp
...
# wget -r -nH --cut-dirs=5 --continue --no-remove-listing --ftp-user='gaoqg229_gmail.com' --ftp-password='SP+wari8' ftp://ftp.ptree.jaxa.jp/pub/himawari/L2/CLP/010/2016\${month}/* -P /home/563/qg8515/data/obs/jaxa/clp
