...
vars = [
    'TCF', 'qcf', 'qcl', 'qr', 'hus', 'hur', 'ta', 'ua', 'va', 'wap', 'zg', 'pa', 'theta', 'wa', 'rsu', 'rsd', 'rsucs', 'rsdcs', 'rlu', 'rld', 'rlucs', 'rldcs', 'clslw', 'rain_evap', 'updraught_mf', 'downdraught_mf', 'deepc_mf', 'congestusc_mf', 'shallowc_mf', 'midc_mf', 'qc', 'qt',
