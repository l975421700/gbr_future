...
imode = 'diff' #'org' #
vars = ['psl', 'rlut'] #['psl', 'cll'] #['psl', 'pr'] #['psl', 'huss'] #['psl', 'prw'] #['psl', 'clm'] #['psl', 'clh'] #['psl', 'clt'] #['psl', 'clwvi'] #['psl', 'clivi'] #['psl', 'evspsbl'] #['psl', 'hfls'] #['psl', 'hfss'] #['psl', 'sfcWind'] #['psl', 'tas'] #['psl', 'hurs'] #['psl', 'rsut'] #['psl', 'rlut'] #['psl', 'uas', 'vas'] #
